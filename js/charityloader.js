...
function populateCharities(val, location){
  ...
  $( "#"+val.charityName ).append( '<div class="card mb-3 my-5" style="max-width: 100%; max-height: 90%;" id="'+ val.charityName +'CARD"></div>');
  $( "#"+val.charityName+"CARD" ).append('<div class="row no-gutters cardoverall" id="'+ val.charityName +'ROW"></div>');
