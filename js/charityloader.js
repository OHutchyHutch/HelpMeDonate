...
function populateCharities(val, location){
  ...
  $( '#'+val.charityName+'CARDBODY' ).append('<h5 class="card-title" style="font-size: 1.2vw;">'+charityNameSpaces+'</h5>').append('<p class="card-text"  style="font-size: .85vw;">'+val.charityGoal+'</p>');
}